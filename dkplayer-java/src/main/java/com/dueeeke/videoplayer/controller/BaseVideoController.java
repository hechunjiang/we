...
import com.dueeeke.videoplayer.likeview.LoveAnimator;
import com.dueeeke.videoplayer.likeview.MyView;
...
//        LoveAnimator loveAnimator = new LoveAnimator(getContext());
//        MyView myView = new MyView(getContext());
//
//        loveAnimator.addView(myView);
//        this.addView(loveAnimator);
