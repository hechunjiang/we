...
public class VideoEditActivity extends BaseActivity {
    ...
    private void initGuide() {
        final GuidePage page = GuidePage
                .newInstance()
                .setLayoutRes(R.layout.info_edit_right)
                .addHighLight(ll_right_menu)
        ...
        final GuidePage page1 = GuidePage
                .newInstance()
                .setLayoutRes(R.layout.info_edit_bottom)
                .addHighLight(iv_play_all, HighLight.Shape.CIRCLE)
                .setEverywhereCancelable(false)//是否点击任意地方跳转下一页或者消失引导层，默认true
                .setOnLayoutInflatedListener(new OnLayoutInflatedListener() {
                    @Override
                    public void onLayoutInflated(View view, final Controller controller) {
...
//            CustomTimelineUtil.buildTimelineMusic(currentTimeline.getTimeline(), m_musicInfo);
...
//            mVideoFragment.updateSeekBarMaxValue();
            ...
            tv_beauty.setTextColor(ContextCompat.getColor(VideoEditActivity.this, R.color.a4a4));
            tv_scenery.setTextColor(ContextCompat.getColor(VideoEditActivity.this, R.color.bg_white));
        } else if (v == tv_beauty) {
            filterSelect = 1;
            ...
            mFiltersAdapter.notifyDataSetChanged();
            tv_scenery.setTextColor(ContextCompat.getColor(VideoEditActivity.this, R.color.a4a4));
            tv_beauty.setTextColor(ContextCompat.getColor(VideoEditActivity.this, R.color.bg_white));
        } else if (v == iv_close) {
    ...
    private void selectVideo(int pos) {
        ...
        Intent intent = new Intent(VideoEditActivity.this, ImportVideoActivity.class);
    ...
    private void initTimeLines() {
        ...
        //创建时间总线
        if (!TimelineManager.getInstance().createMasterTimeline(this)) {
            return;
        }


        //创建分支时间
        if (!TimelineManager.getInstance().createBranchTimeline()) {
            return;
        }
...
//                AppManager.getInstance().jumpActivityForResult(AppManager.getInstance().currentActivity(), FilterActivity.class, null, VideoEditActivity.REQUESTRESULT_FILTER);
            ...
            case 1:  // special effect
                m_waitFlag = true;
                AppManager.getInstance().jumpActivityForResult(AppManager.getInstance().currentActivity(), EffectActivity.class, null, VideoEditActivity.REQUESTRESULT_EFFECT);
                break;
            case 2:  // music
                m_waitFlag = true;

                Intent intent = new Intent(VideoEditActivity.this, MusicActivity.class);
            ...
            case 3: //transition
                if (TimelineManager.getInstance().getSingleTimelineList() != null && TimelineManager.getInstance().getSingleTimelineList().size() > 1) {
                    ...
                    LogUtil.showLog("重置");
                    m_waitFlag = true;
                    AppManager.getInstance().jumpActivityForResult(AppManager.getInstance().currentActivity(), TransitionActivity.class, null, VideoEditActivity.REQUESTRESULT_TRANSITION);
            ...
            case 4:  //text
                ...
                AppManager.getInstance().jumpActivityForResult(AppManager.getInstance().currentActivity(), CaptionActivity.class, null, VideoEditActivity.REQUESTRESULT_CAPTION);
                break;
            case 5:  //sticker
                m_waitFlag = true;
                AppManager.getInstance().jumpActivityForResult(AppManager.getInstance().currentActivity(), AnimateStickerActivity.class, null, VideoEditActivity.REQUESTRESULT_STICKER);
                break;
            case 6:
                ll_cut_music.setVisibility(View.GONE);
                filter_layout.setVisibility(View.GONE);
            ...
            case 9:  //copy
                ...
                CustomTimelineUtil.buildMasterTranistion(VideoEditActivity.this);
                CustomTimelineUtil.reMasterBuildVideoTrack();
                break;
            case 10:  //delete

                if (mClipInfoArray.size() <= 1) {
                    Toast.makeText(VideoEditActivity.this, R.string.del_tip, Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (TimelineManager.getInstance().removeBranchTimeline(selectPosDel)) {
                    ...
                    Toast.makeText(VideoEditActivity.this, R.string.del_error, Toast.LENGTH_SHORT).show();
                }
