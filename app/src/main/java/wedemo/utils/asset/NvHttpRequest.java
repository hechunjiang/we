...
public class NvHttpRequest {
    ...
    public void downloadAsset(String srcFileUrl, String desFilePath, NvHttpRequestListener downloadListener, String downloadId) {
        ...
        try {
            ...
            if (localDownloadListener != null) {
                localDownloadListener.onDonwloadAssetFailed(e, localDownloadId);
            }
        }
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        while ((len = httpInputStream.read(byteStreamArray)) != -1) {
                            ...
                            if (localDownloadListener != null) {
                                localDownloadListener.onDonwloadAssetProgress(progress, localDownloadId);
                            }
                        }
                        ...
                        accessFile.close();
                        if (localDownloadListener != null) {
                            localDownloadListener.onDonwloadAssetSuccess(true, desFileUrl, localDownloadId);
                        }
    ...
    public interface NvHttpRequestListener {
        ...
        void onDonwloadAssetProgress(int progress, String downloadId);

        void onDonwloadAssetSuccess(boolean success, String downloadPath, String downloadId);

        void onDonwloadAssetFailed(Exception e, String downloadId);
    }
}
