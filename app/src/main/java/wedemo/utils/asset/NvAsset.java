...
public class NvAsset {
    ...
    public static final int ASSET_LIC = 12;
    public static final int ASSET_FILTER_BEAUTY = 13;
    ...
    public static final int AspectRatio_All = 15;
    ...
    public String licAessetPath = "";
    public String licStorePath = "";
    ...
    public String getLicAessetPath() {
        return licAessetPath;
    }

    public void setLicAessetPath(String licAessetPath) {
        this.licAessetPath = licAessetPath;
    }

    public String getLicStorePath() {
        return licStorePath;
    }

    public void setLicStorePath(String licStorePath) {
        this.licStorePath = licStorePath;
    }
    ...
    public int getPackageType() {
        if (assetType == NvAsset.ASSET_THEME) {
            ...
            return NvsAssetPackageManager.ASSET_PACKAGE_TYPE_ANIMATEDSTICKER;
        } else if (assetType == NvAsset.ASSET_FILTER_BEAUTY) {
            return NvsAssetPackageManager.ASSET_PACKAGE_TYPE_VIDEOFX;
        } else {
            return NvsAssetPackageManager.ASSET_PACKAGE_TYPE_THEME;
        }
    ...
    public void copyAsset(NvAsset asset) {
        ...
        licAessetPath = asset.licAessetPath;
        licStorePath = asset.licStorePath;
    }
}
