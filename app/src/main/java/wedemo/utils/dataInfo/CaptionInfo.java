...
public class CaptionInfo {
    ...
    private long m_master_inPoint; //master字幕入点
    ...
    public void setMasterInPoint(long m_master_inPoint) {
        this.m_master_inPoint = m_master_inPoint;
    }

    public long getMasterInPoint() {
        return m_master_inPoint;
    }
    ...
    public CaptionInfo clone() {
        ...
        newCaptionInfo.setMasterInPoint(this.getMasterInPoint());
        ...
        newCaptionInfo.setChangeTrimIn(this.getChangeTrimIn());
        newCaptionInfo.setChangeTrimOut(this.getChangeTrimOut());

        //下标
        newCaptionInfo.setIndex(this.getIndex());
    ...
    public String toString() {
        return "CaptionInfo{" +
                ", changeTrimIn=" + changeTrimIn +
                ", changeTrimOut=" + changeTrimOut +
                ", m_inPoint=" + m_inPoint +
