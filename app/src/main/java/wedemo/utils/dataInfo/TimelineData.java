...
public class TimelineData {
    ...
    private MusicListResponse.DataBean mMusicData = null;

    private MusicInfo masterMusic = null;

    public MusicInfo getMasterMusic() {
        return masterMusic;
    }

    public void setMasterMusic(MusicInfo masterMusic) {
    ...
    public void setmMusicData(MusicListResponse.DataBean mMusicData) {
