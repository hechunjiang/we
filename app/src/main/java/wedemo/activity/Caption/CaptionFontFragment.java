...
public class CaptionFontFragment extends Fragment {
    ...
    private ArrayList<CaptionFontInfo> mCaptionFontInfolist = new ArrayList<>();
    ...
    public void setFontInfolist(ArrayList<CaptionFontInfo> fontInfolist) {
        ...
        if (mCaptionFontRecycleAdapter != null)
            mCaptionFontRecycleAdapter.setFontInfoList(fontInfolist);
    }
    ...
    private void initAssetRecycleAdapter() {
        ...
        mCaptionFontRecycleAdapter.setFontInfoList(mCaptionFontInfolist);
        mCaptionFontRecycleView.setAdapter(mCaptionFontRecycleAdapter);
        mCaptionFontRecycleView.addItemDecoration(new SpaceItemDecoration(0, 14));
        mCaptionFontRecycleAdapter.setOnItemClickListener(new OnItemClickListener() {
            @Override
