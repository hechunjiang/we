...
public class TransitionAdapter extends RecyclerView.Adapter<TransitionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (itemData == null) {
            itemData = new FilterItem();
            itemData.setFilterId(null);
            itemData.setFilterMode(FilterItem.FILTERMODE_BUILTIN);
            itemData.setFilterName(mContext.getString(R.string.no_info));
            itemData.setImageId(R.mipmap.no_data);
        }
