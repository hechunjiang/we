...
public class MusicListAdapter extends RecyclerView.Adapter<MusicListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (audioInfo.isPlay()) {
            holder.item_music_play_btn.setBackground(ContextCompat.getDrawable(mContext, R.mipmap.music_pause));
        } else {
            holder.item_music_play_btn.setBackground(ContextCompat.getDrawable(mContext, R.mipmap.music_play));
        }
