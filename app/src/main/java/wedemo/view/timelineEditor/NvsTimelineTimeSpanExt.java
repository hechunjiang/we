            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        mLeftHandleImage.setImageResource(R.mipmap.trimline_select);
                        mRightHandleImage.setImageResource(R.mipmap.trimline);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        mLeftHandleImage.setImageResource(R.mipmap.trimline);
                        mRightHandleImage.setImageResource(R.mipmap.trimline_select);
