...
public class NvsTimelineTimeSpan extends RelativeLayout {
    ...
    //
    private long minDraggedTimeSpanDuration = 2000000;
    ...
    private void right(int dx) {
        ...
        if (originRight - originLeft <= minDraggedTimeSpanPixel) {
            originRight = originLeft + minDraggedTimeSpanPixel;
        }
    }
    ...
    private void left(int dx) {
        ...
        if (originRight - originLeft <= minDraggedTimeSpanPixel) {
            originLeft = originRight - minDraggedTimeSpanPixel;
        }
    }
}
